let received_txt = `<div class="flex flex-wrap gap-x-3 items-center mt-4 border-t ">
                        <div>
                        ...
                        <div class="">
                            ...
                            <input type="text" name="email" id="email"
                                class="w-20 rounded-md border text-xs border-gray-900 bg-white py-3 pl-2 text-[#6B7280] h-6 outline-none focus:border-[#6A64F1] focus:shadow-md" />
                        </div>
                        <div class="">
                            ...
                            <input type="text" name="email" id="email"
                                class="w-32 rounded-md border text-xs border-gray-900 bg-white py-3 pl-2 text-[#6B7280] h-6 outline-none focus:border-[#6A64F1] focus:shadow-md" />
                        </div>
                        <div class="">
                            <label class="block mb-2 font-bold text-xs font-medium text-gray-900 dark:text-white">Item
                                Desc :
...
let reject_txt = `<div class="flex flex-wrap gap-x-3 items-center mt-3 border-black border-t pt-2">
                        <div>
                            <input id="link-checkbox" type="checkbox" value=""
                                class="w-3 h-3 text-blue-600 bg-gray-100 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:border-gray-600">
                        </div>
                        ...
                        <div class="">
                            <input type="text" name="email" id="email" placeholder="Demage" disabled
...
let accept_txt = `<div class="flex flex-wrap items-center gap-x-3 mt-3 border-black border-t pt-2">
                                           <div>
                            <input id="link-checkbox" type="checkbox" value=""
                                class="w-3 h-3 text-blue-600 bg-gray-100 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:border-gray-600">
                        </div>
...
function accept() {
    ...
    let lot_btn = document.getElementById('lot_btn')

    if (lot_btn.style.display === "none") {
        lot_btn.style.display = "block";
    } else {
        lot_btn.style.display = "block";
    }
...
function form_radio(){
    let x=document.getElementById("serial_from")
    let y=document.getElementById("serial_to")
    let z=document.getElementById("lot_no")

    if(z.checked){
        x.innerHTML = "Lot Number From"
        y.innerHTML = "Lot Number To"
    }
